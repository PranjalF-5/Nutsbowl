...
import { Sun, Sprout, PackageCheck } from 'lucide-react';
...
export const Process: React.FC = () => {
  return (
    <section className="py-24 px-0 md:px-4 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-12 left-0 right-0 h-[2px] bg-nutribowl-cream -z-10 transform translate-y-1/2" />

          {/* Scroll Container (Mobile: Flex + Scroll Snap, Desktop: Grid) */}
          <div className="flex md:grid md:grid-cols-3 gap-6 md:gap-8 overflow-x-auto md:overflow-visible pb-8 md:pb-0 px-6 md:px-0 snap-x snap-mandatory scrollbar-hide">
            {steps.map((step, idx) => (
              <motion.div
                key={idx}
                ...
                className="group flex-shrink-0 w-[80vw] md:w-auto snap-center"
              >
                <div className="flex flex-col items-center text-center space-y-6 bg-white p-4 h-full">
